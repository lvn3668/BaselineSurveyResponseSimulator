...
public class MentalHealthDepression extends MentalHealthResponse {
	...
	public MentalHealthDepression(VeteranCohort veteranCohort) throws Exception {
		...
		try {
			...
			this.setUniformdistribution(new RandomizingDistribution(MentalHealthDepression.getMintogenerateerrorval(),
	...
	public MentalHealthDepression(VeteranCohort veteranCohort, ValueRange valuerange, int simulatedresponse)
			throws Exception {
