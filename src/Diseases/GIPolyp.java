...
public class GIPolyp extends GastroIntestinalDiseaseResponse {
	...
	public GIPolyp(VeteranCohort veteranCohort) throws Exception {
		super(veteranCohort);
		try {
	...
	public GIPolyp(VeteranCohort veteranCohort, ValueRange valuerange, int simulatedresponse) throws Exception {
