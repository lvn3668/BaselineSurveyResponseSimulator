...
public class GICrohnsDisease extends GastroIntestinalDiseaseResponse {
	...
	public GICrohnsDisease(VeteranCohort veteranCohort) throws Exception {
		super(veteranCohort);
		try {
	...
	public GICrohnsDisease(VeteranCohort veteranCohort, ValueRange valuerange, int simulatedresponse) throws Exception {
