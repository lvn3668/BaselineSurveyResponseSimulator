...
public class GIUlceritiveColitis extends GastroIntestinalDiseaseResponse {
	...
	public GIUlceritiveColitis(VeteranCohort veteranCohort) throws Exception {
		...
		try {
			...
			this.setUniformdistribution(new RandomizingDistribution(GIUlceritiveColitis.getMintogenerateerrorval(),
	...
	public GIUlceritiveColitis(VeteranCohort veteranCohort, ValueRange valuerange, int simulatedresponse)
			throws Exception {
	...
	public void simulateResponses(VeteranCohort veterancohort) throws Exception {
		...
		// add getters for uniform dist and random epic vars
			...
			this.setGIUCMedsAdministeredEpicResponse(this.getUtilities().randBetween(
					GIUlceritiveColitis.getMintogenerateerrorval(), GIUlceritiveColitis.getMaxtogenerateerrorval()));
		}
	}
