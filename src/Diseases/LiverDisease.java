...
public class LiverDisease extends OsteopathicDiseaseResponse {
	...
	public LiverDisease(VeteranCohort veteranCohort) throws Exception {
		super(veteranCohort);
		try {
	...
	public LiverDisease(VeteranCohort veteranCohort, ValueRange valuerange, int simulatedresponse) throws Exception {
