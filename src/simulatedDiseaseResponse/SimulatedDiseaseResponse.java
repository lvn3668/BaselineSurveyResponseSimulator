...
public class SimulatedDiseaseResponse {
	...
	public SimulatedDiseaseResponse(VeteranCohort veteranCohort) throws Exception {
		...
		try {
			this.setAcuteSpinalCordInjury(new AcuteSpinalCordInjury(veteranCohort));
			this.setAlzheimers(new Alzheimers(veteranCohort));
			this.setAmytrophiclateralsclerosis(new AmytrophicLateralSclerosis(veteranCohort));
			this.setArthritis(new SkinMsArthritis(veteranCohort));
			this.setAsthma(new Asthma(veteranCohort));
			this.setBPH(new BenignProstaticHyperplasia(veteranCohort));
			this.setBlindness(new Blindness(veteranCohort));
			this.setBloodclots(new BloodClots(veteranCohort));
			this.setBreastCancer(new BreastCancer(veteranCohort));
			this.setCataract(new Cataract(veteranCohort));
			this.setCad(new CoronaryArteryDisease(veteranCohort));
			this.setCholesterol(new Cholesterol(veteranCohort));
			this.setCirculatorydiseaseother(new CirculatoryDiseaseOther(veteranCohort));
			this.setColonCancer(new ColonCancer(veteranCohort));
			this.setCongestiveheartfailure(new CongestiveHeartFailure(veteranCohort));
			this.setCoronaryarterydisease(new CoronaryArteryDisease(veteranCohort));
			this.setDementia(new Dementia(veteranCohort));
			this.setEpilepsy(new Epilepsy(veteranCohort));
			this.setGIAcidReflux(new GIAcidReflux(veteranCohort));
			this.setGICeliacDisease(new GICeliacDisease(veteranCohort));
			this.setGICrohnsDisease(new GICrohnsDisease(veteranCohort));
			this.setGiOtherDisease(new GIDiseaseOther(veteranCohort));
			this.setGiIrritableBowelSyndrome(new GIIrritableBowelSyndrome(veteranCohort));
			this.setGIObstruction(new GIObstruction(veteranCohort));
			this.setGiPolyp(new GIPolyp(veteranCohort));
			this.setGiUlceritiveColitis(new GIUlceritiveColitis(veteranCohort));
			this.setGiUlcer(new GIUlcer(veteranCohort));
			this.setGlaucoma(new Glaucoma(veteranCohort));
			this.setHearingLoss(new HearingLoss(veteranCohort));
			this.setHeartAttack(new HeartAttack(veteranCohort));
			this.setHepatisisC(new HepatitisC(veteranCohort));
			this.setHiv(new HIV(veteranCohort));
			this.setHighBloodPressureDisease(new HighBloodPressureDisease(veteranCohort));
			this.setHypertension(new Hypertension(veteranCohort));
			this.setIDOther(new InfectiousDiseaseOther(veteranCohort));
			this.setKidneyDialysis(new KidneyDialysis(veteranCohort));
			this.setKidneyDiseaseAcute(new KidneyDiseaseAcute(veteranCohort));
			this.setKidneyNoDialysis(new KidneyNoDialysis(veteranCohort));
			this.setLiverDisease(new LiverDisease(veteranCohort));
			this.setLossofconsciousness(new LossOfConsciousness(veteranCohort));
			this.setLungCancer(new LungCancer(veteranCohort));
			this.setLungDisease(new LungDisease(veteranCohort));
			this.setMaculardegeneration(new MacularDegeneration(veteranCohort));
			this.setMemoryLoss(new MemoryLoss(veteranCohort));
			this.setMentalhealthADHD(new MentalHealthADHD(veteranCohort));
			this.setMentalhealthAnxietyPanic(new MentalHealthAnxietyPanic(veteranCohort));
			this.setMentalhealthBipolarDisorder(new MentalHealthBipolarDisorder(veteranCohort));
			this.setMentalhealthDepression(new MentalHealthDepression(veteranCohort));
			this.setMentalhealthEatingDisorder(new MentalHealthEatingDisorder(veteranCohort));
			this.setMentalhealthother(new MentalHealthOther(veteranCohort));
			this.setMentalhealthpersonalitydisorder(new MentalHealthPersonalityDisorder(veteranCohort));
			this.setMentalhealthptsd(new MentalHealthPostTraumaticStressDisorder(veteranCohort));
			this.setMentalhealthschizophrenia(new MentalHealthSchizophrenia(veteranCohort));
			this.setMentalhealthsocph(new MentalHealthSocPh(veteranCohort));
			this.setMigrane(new Migrane(veteranCohort));
			this.setNeurostimulatorydiseaseother(new NeuroStimulatoryDiseaseOther(veteranCohort));
			this.setAcuteSpinalCordInjury(new AcuteSpinalCordInjury(veteranCohort));
			this.setNSTBI(new NeuroStimulatoryDiseaseTBI(veteranCohort));
			this.setOsteopathicdiseaseother(new OsteopathicDiseaseOther(veteranCohort));
			this.setOsteopathicdiseaseskin(new OsteopathicDiseaseSkin(veteranCohort));
			this.setCancerOther(new OtherCancer(veteranCohort));
			this.setParkinsons(new ParkinsonsDisease(veteranCohort));
			this.setProstateCancer(new ProstateCancer(veteranCohort));
			this.setPulmonaryvasculardisease(new PulmonaryVascularDisease(veteranCohort));
			this.setSkinCancer(new SkinCancer(veteranCohort));
			this.setSkinMSGout(new SknMSGout(veteranCohort));
			this.setSkinMSOA(new SknMSOA(veteranCohort));
			this.setSkinMsRA(new SknMsRA(veteranCohort));
			this.setSknMSOthr(new SknMSOthr(veteranCohort));
			this.setSleepApnea(new SleepApnea(veteranCohort));
			this.setStroke(new Stroke(veteranCohort));
			this.setThyroid(new Thyroid(veteranCohort));
			this.setTia(new TransientIschemicAttack(veteranCohort));
			this.setTinitus(new Tinitus(veteranCohort));
			this.setTuberculosis(new Tuberculosis(veteranCohort));
			this.setMultiplesclerosis(new MultipleSclerosis(veteranCohort));
			this.setDiabetes(new Diabetes(veteranCohort));
		} catch (Exception e) {
